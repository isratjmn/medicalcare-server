...
const getSuperAdminMetaData = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const paymentCount = yield prisma_1.default.patient.count();
    ...
    const barChartData = yield getBarChatData();
...
const getBarChatData = () => __awaiter(void 0, void 0, void 0, function* () {
